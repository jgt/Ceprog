<head>
    <meta charset="UTF-8">
    <title>Portaluc - @yield('htmlheader_title', 'Your title here') </title>
    ...
    <link rel="stylesheet" href="{{ asset('css/vendor/select2.css')}}" rel="stylesheet" type="text/css" />

    <link rel="stylesheet" href="{{ asset('css/vendor/alertify.core.css')}}" rel="stylesheet" type="text/css" />

     <link rel="stylesheet" href="{{ asset('css/vendor/alertify.default.css')}}" rel="stylesheet" type="text/css" />
