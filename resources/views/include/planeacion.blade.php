...
MODALIDAD SEMIESCOLARIZADO
  ...
  <div class="col-xs-2">
	...
	{!! Form::select('user_id', [$users->id => $users->name], null, [ 'id' => 'user_list', 'class' => 'form-control', 'multiple'])!!}
  </div>
  <div class="col-xs-3">
   ...
   <div class="col-xs-3">
   	{!! Form::label('carrera', 'Carrera/Semestre')!!}
  	{!! Form::select('carrera', [$materias->semestre->name,], null, ['id' => 'materia_list', 'class' => 'form-control', 'multiple'])!!}
  </div>
   <div class="col-xs-1">
 ...
 <div class="col-xs-2">
	...
	{!! Form::select('materia_id', [ $materias->id => $materias->name], null, [ 'id' => 'tag_list', 'class' => 'form-control', 'multiple'])!!}
  </div>
   <div class="col-xs-2">
...
<div class="col-md-8" id="reinscripcion">
   ...
   <div class="col-md-8" id="reinscripcion">
	...
	{!! Form::select('asesor', [$users->id => $users->name], ['class' => 'form-control'])!!}
  </div>
  <br> <br> <br>
  <div class="">
   <h3>Reviso</h3>
