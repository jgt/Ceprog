...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"<span class='fa fa-chevron-right'></span>",sPrevious:"<span class='fa fa-chevron-left'></span>"},sEmptyTable:"No hay informacion disponible para la tabla",sInfo:"Mostrando _START_ a _END_ de _TOTAL_ ",sInfoEmpty:"Mostrando 0 to 0 of 0 entradas",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",
sThousands:",",sLengthMenu:"Mostrar _MENU_ ",sLoadingRecords:"Cargando...",sProcessing:"Procesando...",sSearch:"",sSearchPlaceholder:"Buscar",sUrl:"",sZeroRecords:"No matching records found"},oSearch:g.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null};V(p.defaults);p.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc","desc"],bSearchable:!0,
